(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("fuse.js"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "fuse.js"], factory);
	else if(typeof exports === 'object')
		exports["<lib name>"] = factory(require("react"), require("fuse.js"));
	else
		root["<lib name>"] = factory(root["react"], root["fuse.js"]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_create_react_context__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_create_react_context___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_create_react_context__);
...
var FuseBox = function (_React$Component) {
  ...
  function FuseBox(props) {
    ...
    var results = _this.getResults(fuse, value);
  ...
  _createClass(FuseBox, [{
    ...
    value: function componentDidUpdate(prevProps) {
      if (this.props.list !== prevProps.list) {
        ...
        var results = this.getResults(fuse, this.state.value);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getResults = function (fuse, value) {
    var searchResults = fuse.search(value);
    var emptyResults = value ? [] : _this2.props.list.map(function (item) {
      return { item: item, matches: [] };
    });
    var results = searchResults.length ? searchResults : emptyResults;
  ...
  this.handleInputChange = function (event) {
    ...
    var results = _this2.getResults(_this2.state.fuse, value);
    _this2.setState({ results: results, value: value });
  ...
  this.handleInputKeyDown = function (event) {
    switch (event.keyCode) {
      ...
      case 13:
        ...
        return _this2.props.handleSubmit(item);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FuseBox__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__CurrentResults__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__InputBus__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Highlighter__ = __webpack_require__(17);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Highlighter", function() { return __WEBPACK_IMPORTED_MODULE_3__Highlighter__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__FuseBox__ = __webpack_require__(3);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_highlight_words_core__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_highlight_words_core___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_highlight_words_core__);
...
var Light = __WEBPACK_IMPORTED_MODULE_2_styled_components__["a" /* default */].mark(_templateObject);
...
var Highlighter = function (_React$Component) {
  ...
  function Highlighter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Highlighter.__proto__ || Object.getPrototypeOf(Highlighter)).call.apply(_ref, [this].concat(args))), _this), _this.indicesToChunks = function (_ref2) {
  ...
  _createClass(Highlighter, [{
    ...
    value: function renderContent() {
      ...
      var _props$match = this.props.match,
          _props$match$indices = _props$match.indices,
          indices = _props$match$indices === undefined ? [] : _props$match$indices,
          _props$match$value = _props$match.value,
          value = _props$match$value === undefined ? "" : _props$match$value;


      var chunks = indices.map(this.indicesToChunks);
      var stringZones = Object(__WEBPACK_IMPORTED_MODULE_3_highlight_words_core__["fillInChunks"])({
        chunksToHighlight: Object(__WEBPACK_IMPORTED_MODULE_3_highlight_words_core__["combineChunks"])({ chunks: chunks }),
        totalLength: value ? value.length : 0
      });

      return stringZones.map(function (chunk, index) {
        var text = value.slice(chunk.start, chunk.end);
        var Tag = chunk.highlight ? _this2.props.Mark : "span";
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          Tag,
          { key: index },
          text
...
Highlighter.propTypes = {
  ...
  Mark: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.any,
  match: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
    indices: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.array.isRequired,
    value: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired
  }),
  string: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_is_plain_object__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_is_plain_object___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_is_plain_object__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stylis__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stylis___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_stylis__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_stylis_rule_sheet__ = __webpack_require__(23);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(2), __webpack_require__(19)(module)))
